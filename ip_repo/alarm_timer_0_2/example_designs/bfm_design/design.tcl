proc create_ipi_design { offsetfile design_name } {
	...
	set alarm_timer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:alarm_timer:0.2 alarm_timer_0]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/alarm_timer_v0_2_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef alarm_timer_v0_2_tb_include_vh_"
	puts $fp "`define alarm_timer_v0_2_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:alarm_timer:0.2]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/alarm_timer_v0_2_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "alarm_timer_v0_2_bfm_${i}"
...
remove_files -quiet -fileset sim_1 alarm_timer_v0_2_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top alarm_timer_v0_2_tb [get_filesets sim_1]
