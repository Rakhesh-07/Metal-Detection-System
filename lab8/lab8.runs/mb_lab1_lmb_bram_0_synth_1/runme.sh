...
HD_PWD='D:/EECE387/lab5/lab5.runs/mb_lab1_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab1_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_lab1_lmb_bram_0.tcl
