...
HD_PWD='D:/EECE387/lab8/lab8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_lab1_wrapper.tcl
