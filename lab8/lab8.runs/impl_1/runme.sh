...
HD_PWD='D:/EECE387/lab8/lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_lab1_wrapper.tcl -notrace
