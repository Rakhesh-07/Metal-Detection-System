...
#
# Script generated by Vivado on Tue Mar 26 10:38:46 -0400 2024
...
#
# Usage        : mb_lab1.sh
#                mb_lab1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mb_lab1.sh [-reset_run]
#                mb_lab1.sh [-reset_log]
#                mb_lab1.sh [-help]
#
...
#                script (type 'mb_lab1.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname microblaze_v11_0_12 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_pkg_v1_0_3 -libname lib_srl_fifo_v1_0_3 -libname lib_cdc_v1_0_2 -libname axi_uartlite_v2_0_33 -libname lmb_v10_v3_0_13 -libname lmb_bram_if_cntlr_v4_0_23 -libname blk_mem_gen_v8_4_7 -libname generic_baseblocks_v2_1_1 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_29 -libname fifo_generator_v13_2_9 -libname axi_data_fifo_v2_1_28 -libname axi_crossbar_v2_1_30 -libname axi_intc_v4_1_18 -libname xlconcat_v2_1_5 -libname mdm_v3_2_25 -libname proc_sys_reset_v5_0_14 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_31 -libname xlslice_v1_0_3 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm microblaze_v11_0_12 xil_defaultlib axi_lite_ipif_v3_0_4 lib_pkg_v1_0_3 lib_srl_fifo_v1_0_3 lib_cdc_v1_0_2 axi_uartlite_v2_0_33 lmb_v10_v3_0_13 lmb_bram_if_cntlr_v4_0_23 blk_mem_gen_v8_4_7 generic_baseblocks_v2_1_1 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_29 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_crossbar_v2_1_30 axi_intc_v4_1_18 xlconcat_v2_1_5 mdm_v3_2_25 proc_sys_reset_v5_0_14 interrupt_control_v3_1_5 axi_gpio_v2_0_31 xlslice_v1_0_3)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mb_lab1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mb_lab1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  ...
  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  "../../../bd/mb_lab1/ip/mb_lab1_lmb_bram_0/sim/mb_lab1_lmb_bram_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  "../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  "../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  "../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  "../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  ...
  xmvlog -work xlconcat_v2_1_5 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
  ...
  xmvlog -work xlslice_v1_0_3 $xmvlog_opts +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/ec67/hdl" +incdir+"../../../../lab6.gen/sources_1/bd/mb_lab1/ipshared/c2c6" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mb_lab1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mb_lab1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mb_lab1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mb_lab1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mb_lab1.sh [-help]\n\
Usage: mb_lab1.sh [-step]\n\
Usage: mb_lab1.sh [-lib_map_path]\n\
Usage: mb_lab1.sh [-reset_run]\n\
Usage: mb_lab1.sh [-reset_log]\n\
Usage: mb_lab1.sh [-keep_index]\n\
Usage: mb_lab1.sh [-noclean_files]\n\n\
